  ...
  const services = [
    {
      ...
      features: [
        t("services.comprehensive.features.0"),
        t("services.comprehensive.features.1"),
        t("services.comprehensive.features.2"),
      ],
    ...
    },
    {
      ...
      features: [
        t("services.organization.features.0"),
        t("services.organization.features.1"),
        t("services.organization.features.2"),
      ],
    ...
    },
    {
      ...
      features: [
        t("services.operation.features.0"),
        t("services.operation.features.1"),
        t("services.operation.features.2"),
      ],
